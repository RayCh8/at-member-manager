...
// AtMemberManagerServer is an autogenerated mock type for the AtMemberManagerServer type
type AtMemberManagerServer struct {
	mock.Mock
}

// CreateMember provides a mock function with given fields: _a0, _a1
func (_m *AtMemberManagerServer) CreateMember(_a0 context.Context, _a1 *pb.CreateMemberReq) (*pb.CreateMemberRes, error) {
...
func (_m *AtMemberManagerServer) DeleteMember(_a0 context.Context, _a1 *pb.DeleteMemberReq) (*pb.DeleteMemberRes, error) {
	ret := _m.Called(_a0, _a1)
...
func (_m *AtMemberManagerServer) Health(_a0 context.Context, _a1 *pb.HealthReq) (*pb.HealthRes, error) {
	ret := _m.Called(_a0, _a1)
...
func (_m *AtMemberManagerServer) ListMembers(_a0 context.Context, _a1 *pb.ListMembersReq) (*pb.ListMembersRes, error) {
	ret := _m.Called(_a0, _a1)
...
func (_m *AtMemberManagerServer) UpdateMember(_a0 context.Context, _a1 *pb.UpdateMemberReq) (*pb.UpdateMemberRes, error) {
	ret := _m.Called(_a0, _a1)
...
type mockConstructorTestingTNewAtMemberManagerServer interface {
	mock.TestingT
	Cleanup(func())
}

// NewAtMemberManagerServer creates a new instance of AtMemberManagerServer. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
func NewAtMemberManagerServer(t mockConstructorTestingTNewAtMemberManagerServer) *AtMemberManagerServer {
	mock := &AtMemberManagerServer{}
	mock.Mock.Test(t)
