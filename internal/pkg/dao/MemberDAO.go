...
// UpdateMember provides a mock function with given fields: _a0, _a1, _a2
func (_m *MemberDAO) UpdateMember(_a0 context.Context, _a1 int64, _a2 *dao.Member) (*dao.Member, error) {
	ret := _m.Called(_a0, _a1, _a2)

	var r0 *dao.Member
	if rf, ok := ret.Get(0).(func(context.Context, int64, *dao.Member) *dao.Member); ok {
		r0 = rf(_a0, _a1, _a2)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*dao.Member)
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(context.Context, int64, *dao.Member) error); ok {
		r1 = rf(_a0, _a1, _a2)
	} else {
		r1 = ret.Error(1)
	}
